...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--hidden_dim', type=int, default=400, help='hidden dim of basic layers')
        self.parser.add_argument('--cnn_dim', type=int, default=512, help='hidden dim of cnn layers')
        ...
        self.parser.add_argument('--oversampling', type=int, default=80, help='kruskal statistics threshold')        
